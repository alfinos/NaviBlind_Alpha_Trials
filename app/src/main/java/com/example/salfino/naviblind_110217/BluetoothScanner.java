...
public class BluetoothScanner extends AppCompatActivity {
    ...
    private ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            //Toast.makeText(BluetoothScanner.this, "Receiving Scan Results...", Toast.LENGTH_LONG).show();
            ...
            //Toast.makeText(BluetoothScanner.this, "MAC ADDRESS::" + result.getDevice().getAddress() , Toast.LENGTH_SHORT).show();
            //Toast.makeText(BluetoothScanner.this, "ADVERTISMENT::" + advertisingString  , Toast.LENGTH_SHORT).show();
            //Toast.makeText(BluetoothScanner.this, "RSSI::" + result.getRssi()  , Toast.LENGTH_SHORT).show();
