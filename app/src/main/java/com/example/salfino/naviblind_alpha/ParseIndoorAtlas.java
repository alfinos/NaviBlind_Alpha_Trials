                ...
                switch (eventType){
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if(inEntry){
                            ...
                            } else if ("defaultfloorcertainty".equalsIgnoreCase(tagName)) {//Guaranteed not to be Null
                                    currentRecord.setDefaultfloorcertainty(textValue);
                            ...
                            } else if ("maxduration".equalsIgnoreCase(tagName)) {//Guaranteed not to be Null
                                    currentRecord.setMaxduration(textValue);
                        }
                        }
                        break;
                    default: //nothing else to do
